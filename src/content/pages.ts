...
export const staticPages: readonly StaticPage[] = [
  ...
  { path: "/sectors/energy", label: "Renewable Energy & Storage", indexable: true, priority: 0.8, changefreq: "monthly", navGroup: "sectors" },
  { path: "/sectors/medical", label: "Medical Devices & Healthcare", indexable: true, priority: 0.8, changefreq: "monthly", navGroup: "sectors" },
  { path: "/sectors/industrial", label: "Industrial Machinery & Smart Devices", indexable: true, priority: 0.8, changefreq: "monthly", navGroup: "sectors" },
  { path: "/case-studies/ethiopia-railway", label: "Ethiopia-Djibouti Railway", indexable: true, priority: 0.85, changefreq: "yearly" },
